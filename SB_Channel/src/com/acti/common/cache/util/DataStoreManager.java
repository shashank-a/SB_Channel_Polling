package com.acti.common.cache.util;

import com.acti.common.cache.serverresource.CachePersistentHelper;
		...
		public static String set( Object key , Object accountNumber , byte[] value )
			{
				...
				try
					{
						resp = CachePersistentHelper.persistCacheStore( value , (String) key , (String) accountNumber, false );
					}
				catch ( Exception e )
					{
						e.printStackTrace();
		...
		public static String set( Object key , byte[] objectContent )
			{
				...
				try
					{
						resp = CachePersistentHelper.persistCacheStore( objectContent , (String) key , null, false );
					}
				catch ( Exception e )
					{
						e.printStackTrace();

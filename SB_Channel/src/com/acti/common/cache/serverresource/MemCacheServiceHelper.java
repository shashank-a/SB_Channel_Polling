...
public class MemCacheServiceHelper
	{
		 ...
		 * @param content
		 */
		public static void setInMemCache(String cacheKey, String nextTurnkey, String accountNumber, byte[] content){
			HashMap <Object ,Object > cacheMapper = null;
			try
				{
...
//						new ScheduleBehaviour().mailSender( "" , " Exception MemCache Deletion " , errorMessage.toString() , null );
		...
		public static void clearCacheForAffectedAccounts( String acctNum ){
			...
			try
				{
					accountSpecific.add( "getAccountJDOTimeZone" );
					accountSpecific.add( "getBrandInformation" );
					accountSpecific.add( "getContactNameAndAnswerphraseCMSTimeZone" );
					accountSpecific.add( "processJobsJDOList" );
					
					accountSpecific.add( "processJobsJDOListRB1" );
					...
					accountIdSpecific.add( "getMessageFormContentByAccountRB1" );
					accountIdSpecific.add( "getScriptsTempplateRB1" );
					accountIdSpecific.add( "getScriptsTempplateNewRB1" );
					accountIdSpecific.add( "getDynamicScriptHelperRB1" );
...
//								System.out.println(" AccountId for cache affected accounts is not null acctNum["+acctNum+"] = "+accountId);
...
//							}
//							else
//								System.out.println(" AccountId for cache affected accounts is -- NULL -- acctNum["+acctNum+"] = "+accountId);
//						}
				}
			catch ( Exception e )
				{

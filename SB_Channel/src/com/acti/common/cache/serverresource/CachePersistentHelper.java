package com.acti.common.cache.serverresource;
...
import com.acti.common.cache.util.DataStoreObject;
import com.sb.common.util.PMF;
						...
						for ( index = 0 ; index < ( memSizeOfObject / 900000 ) ; index++ )
							{
								 ...
								 */
//								if ( isMemCacheStoreOnly )
								MemCacheServiceHelper.setInMemCache( currentCacheKey , newCacheKey , accountNumber , tempList );
								/**
...
//			{
//				//2013-10-21 09:13:48.728-0700 	1382415228728
//				DateFormat df = new SimpleDateFormat( "yyyy-MM-dd hh:mm:ss.SSSZ" );
//				df.setTimeZone( TimeZone.getTimeZone( "America/Los_Angeles" ) );
//				System.out.println("Normal = "+new Date(10/21/2013));
//				System.out.println("1 = "+df.parse( "2013-10-21 00:00:00.000-0700" ).getTime());
//				System.out.println("2 = "+df.parse( "2013-10-21 23:59:59.999-0700" ).getTime());
//				System.out.println(df.format( new Date(1382415228728l) ));
//				System.out.println(df.format( new Date(df.parse( "2013-10-21 00:00:00.000-0700" ).getTime()) ));
//				
//				Calendar cCal = Calendar.getInstance();
//				cCal.setTimeZone( TimeZone.getTimeZone( "America/Los_Angeles" ) );
//				cCal.set( Calendar.YEAR , 2013 );
//				cCal.set( Calendar.MONTH , 10 );
//				cCal.set( Calendar.DATE , 21 );
//				cCal.set( Calendar.HOUR , 9 );
//				cCal.set( Calendar.MINUTE ,13 );
//				cCal.set( Calendar.SECOND , 48 );
//				cCal.set( Calendar.MILLISECOND , 728 );
//				System.out.println( cCal.getTime() );
//				System.out.println( cCal.getTimeInMillis() );
//				
//				System.out.println(df.format( new Date(cCal.getTimeInMillis()) ));
//			}
		/**
